...
ENV REPOSITORY_URL=${REPOSITORY_URL} SENTRY_AUTH_TOKEN=${SENTRY_AUTH_TOKEN} SENTRY_ORG=${SENTRY_ORG} SENTRY_PROJECT=${SENTRY_PROJECT} SENTRY_URL=${SENTRY_URL} VUE_APP_SENTRY_DSN=${VUE_APP_SENTRY_DSN} VITE_ALLOWED_HOST=${VUE_APP_ALLOWED_HOST} VITE_API_URL=${VUE_APP_API_URL} VITE_ENV=${VUE_APP_ENV} VITE_PUBLIC_URL=${VUE_APP_PUBLIC_URL} VITE_MATOMO_URL=${VUE_APP_MATOMO_URL} VITE_MATOMO_SIDE_ID=${VUE_APP_MATOMO_SITE_ID} VITE_MATOMO_DOMAINS=${VUE_APP_MATOMO_DOMAINS}
