...
ENV VITE_DEPLOY=${VITE_DEPLOY} REPOSITORY_URL=${REPOSITORY_URL} VITE_SENTRY_URL=${VITE_SENTRY_URL} VITE_API_URL=${VITE_API_URL} VITE_MATOMO_URL=${VITE_MATOMO_URL} \
 VITE_MATOMO_SITE_ID=${VITE_MATOMO_SITE_ID} VITE_MATOMO_DOMAINS=${VITE_MATOMO_DOMAINS} VITE_PUBLIC_URL=${VITE_PUBLIC_URL} VITE_SENTRY_AUTH_TOKEN=${VITE_SENTRY_AUTH_TOKEN}
